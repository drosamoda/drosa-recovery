...
Qualquer dúvida, estou por aqui 😊`,
  ...
  {
    id: 'tpl_recent_customer',
    name: 'Cliente recente',
    eventType: 'remarketing_recent_customer',
    metaTemplateName: 'cliente_recente_drosa_v2',
    languageCode: 'pt_BR',
    category: TemplateCategory.marketing,
    messagePreview: "Oi, [nome_cliente]! 😊 Que bom ter você como cliente da D'Rosa Moda! Se precisar de ajuda para escolher a próxima peça, é só chamar por aqui.",
  ...
  },
  {
    id: 'tpl_vip_customer',
    name: 'Cliente VIP',
    eventType: 'remarketing_vip_customer',
    metaTemplateName: 'cliente_vip_drosa_v1',
    languageCode: 'pt_BR',
    category: TemplateCategory.marketing,
    messagePreview: "Oi, [nome_cliente]! 😊 Você é uma cliente especial da D'Rosa Moda. Estamos sempre por aqui se precisar de ajuda para escolher looks ou tirar dúvidas sobre pedidos.",
    variables: ['nome_cliente'],
    active: false,
  },
  {
    id: 'tpl_inactive_customer',
    name: 'Cliente inativo',
    eventType: 'remarketing_inactive_customer',
    metaTemplateName: 'cliente_inativo_drosa_v1',
    languageCode: 'pt_BR',
    category: TemplateCategory.marketing,
    messagePreview: "Oi, [nome_cliente]! 😊 Faz um tempinho que você não aparece por aqui na D'Rosa Moda. Estamos com peças novas na loja — se quiser dar uma olhada ou tirar alguma dúvida, é só chamar.",
    variables: ['nome_cliente'],
    active: false,
  },
  {
    id: 'tpl_engaged_no_purchase',
    name: 'Retomada de atendimento',
    eventType: 'remarketing_engaged_no_purchase',
    metaTemplateName: 'atendimento_retomada_drosa_v1',
    languageCode: 'pt_BR',
    category: TemplateCategory.marketing,
    messagePreview: "Oi, [nome_cliente]! 😊 Vi que você já conversou com a gente por aqui. Ficou alguma dúvida sobre tamanhos, cores ou formas de pagamento? Estou à disposição para ajudar.",
    variables: ['nome_cliente'],
    active: false,
  },
]
